...
1. Copy the source code from [`explorer-visual-tweaks-dark.wh.cpp`](https://github.com/VitalSkib/explorer-visual-tweaks-dark/blob/main/explorer-visual-tweaks-dark.wh.cpp).
